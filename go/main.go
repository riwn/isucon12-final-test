...
var (
	tracer = otel.Tracer("isuconquest")
)
...
func connectDB(batch bool) (*sqlx.DB, error) {
	...
	dbx, err := otelsqlx.Open("mysql", dsn)
	if err != nil {
		return nil, err
	}
	return dbx, nil
...
func (h *Handler) adminMiddleware(next echo.HandlerFunc) echo.HandlerFunc {
	return func(c echo.Context) error {
		ctx, span := tracer.Start(c.Request().Context(), "adminMiddleware")
		defer span.End()
		requestAt := time.Now()
...
func (h *Handler) apiMiddleware(next echo.HandlerFunc) echo.HandlerFunc {
	return func(c echo.Context) error {
		ctx, span := tracer.Start(c.Request().Context(), "apiMiddleware")
		defer span.End()
...
func (h *Handler) checkSessionMiddleware(next echo.HandlerFunc) echo.HandlerFunc {
	return func(c echo.Context) error {
		ctx, span := tracer.Start(c.Request().Context(), "checkSessionMiddleware")
		defer span.End()
...
func (h *Handler) checkOneTimeToken(ctx context.Context, token string, tokenType int, requestAt int64) error {
	ctx, span := tracer.Start(ctx, "checkOneTimeToken")
	defer span.End()
...
func (h *Handler) checkViewerID(ctx context.Context, userID int64, viewerID string) error {
	ctx, span := tracer.Start(ctx, "checkViewerID")
	defer span.End()
...
func (h *Handler) checkBan(ctx context.Context, userID int64) (bool, error) {
	ctx, span := tracer.Start(ctx, "checkBan")
	defer span.End()
	banUser := new(UserBan)
...
func (h *Handler) obtainLoginBonus(ctx context.Context, tx *sqlx.Tx, userID int64, requestAt int64) ([]*UserLoginBonus, error) {
	ctx, span := tracer.Start(ctx, "obtainLoginBonus")
	defer span.End()
...
func (h *Handler) obtainPresent(ctx context.Context, tx *sqlx.Tx, userID int64, requestAt int64) ([]*UserPresent, error) {
	ctx, span := tracer.Start(ctx, "obtainPresent")
	defer span.End()
...
func (h *Handler) obtainItem(ctx context.Context, tx *sqlx.Tx, userID, itemID int64, itemType int, obtainAmount int64, requestAt int64) ([]int64, []*UserCard, []*UserItem, error) {
	ctx, span := tracer.Start(ctx, "obtainItem")
	defer span.End()
...
func (h *Handler) listGacha(c echo.Context) error {
	ctx, span := tracer.Start(c.Request().Context(), "listGacha")
	defer span.End()
	userID, err := getUserID(c)
	if err != nil {
		return errorResponse(c, http.StatusBadRequest, err)
...
func (h *Handler) drawGacha(c echo.Context) error {
	ctx, span := tracer.Start(c.Request().Context(), "drawGacha")
	defer span.End()
	userID, err := getUserID(c)
	if err != nil {
		return errorResponse(c, http.StatusBadRequest, err)
...
func (h *Handler) listPresent(c echo.Context) error {
	ctx, span := tracer.Start(c.Request().Context(), "listPresent")
	defer span.End()
...
func (h *Handler) receivePresent(c echo.Context) error {
	ctx, span := tracer.Start(c.Request().Context(), "receivePresent")
	defer span.End()
	defer c.Request().Body.Close()
...
func (h *Handler) listItem(c echo.Context) error {
	ctx, span := tracer.Start(c.Request().Context(), "listItem")
	defer span.End()
	userID, err := getUserID(c)
	if err != nil {
		return errorResponse(c, http.StatusBadRequest, err)
...
func (h *Handler) addExpToCard(c echo.Context) error {
	ctx, span := tracer.Start(c.Request().Context(), "addExpToCard")
	defer span.End()
...
func (h *Handler) updateDeck(c echo.Context) error {
	ctx, span := tracer.Start(c.Request().Context(), "updateDeck")
	defer span.End()
	userID, err := getUserID(c)
	if err != nil {
		return errorResponse(c, http.StatusBadRequest, err)
...
func (h *Handler) reward(c echo.Context) error {
	ctx, span := tracer.Start(c.Request().Context(), "reward")
	defer span.End()
	userID, err := getUserID(c)
	if err != nil {
		return errorResponse(c, http.StatusBadRequest, err)
...
func (h *Handler) home(c echo.Context) error {
	ctx, span := tracer.Start(c.Request().Context(), "home")
	defer span.End()
	userID, err := getUserID(c)
	if err != nil {
		return errorResponse(c, http.StatusBadRequest, err)
